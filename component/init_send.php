 ...
 * @since 3
 */
$message_list_row = $oapost->view_list_row($post_user,null, null, 'private', 'message',null);
 ...
 * @since 3
 */
$message_list = $oapost->view_list($post_user, null, null, 'private', 'message', $page, $max, $sort, $desc,null);
